...
class _DonationsPageState extends State<DonationsPage> {
      ...
      pdf.addPage(
        pw.Page(
          build: (context) => pw.Column(
            children: [
              pw.Text('Donations Report', style: pw.TextStyle(fontSize: 24)),
  ...
  Future<Uint8List> generateReceiptPdf({
    ...
    final logoBytes = await rootBundle.load('assets/img/logo.png'); // make sure this exists
      ...
      pw.Page(
        ...
        build: (context) => pw.Column(
          ...
          children: [
              ...
              children: [
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Tax ID: $taxId",   // ✅ Tax ID shown here
                        style: const pw.TextStyle(fontSize: 12)),
                  ],
                ),
                pw.Container(
            ...
            _receiptItem("Tax ID", taxId),  //included in details
  ...
  void applyFilters() {
    ...
    if (selectedDateRange != null) {
      ...
      d['date'].isAfter(selectedDateRange!.start
          ...
          d['date'].isBefore(selectedDateRange!.end
  ...
  Widget build(BuildContext context) {
    final totalDonated = filteredDonations.fold<int>(
  ...
  /// Progress bar widget
  Widget _buildProgressBar(List<int> milestones, int currentAmount) {
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text("Ksh $currentAmount",
                style: GoogleFonts.inter(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                    color: Colors.black)),
            Text("Next goal: Ksh $nextMilestone",
                style: GoogleFonts.inter(
